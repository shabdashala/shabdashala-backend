...
class Word(MP_Node):
    """
    A word in a language. Uses :py:mod:`django-treebeard`.
    """
    ...
    is_public = models.BooleanField(
        ...
        default=True,
        db_index=True,
        help_text=_("Show this category in search results and word listings."))

    ancestors_are_public = models.BooleanField(
        _('Ancestor words are public'),
        default=True,
        db_index=True,
        help_text=_("The ancestors of this word are public"))
    ...
    def _get_absolute_url(self, parent_slug=None):
        ...
        """
        return reverse('words:detail', kwargs={
